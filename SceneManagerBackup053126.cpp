...
void SceneManager::RenderScene()
{
	...
	scaleXYZ = glm::vec3(2.6f, 0.18f, 0.25f);
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.0f, 4.0f, 0.0f);
	...
	positionXYZ = glm::vec3(-1.32f, 3.35f, 0.0f);
	...
	positionXYZ = glm::vec3(-1.18f, 2.55f, 0.0f);
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 90.0f;
	positionXYZ = glm::vec3(1.50f, 2.55f, 0.0f);
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 90.0f;
	positionXYZ = glm::vec3(-0.96f, 2.55f, 0.0f);
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 90.0f;
	positionXYZ = glm::vec3(1.28f, 2.55f, 0.0f);
